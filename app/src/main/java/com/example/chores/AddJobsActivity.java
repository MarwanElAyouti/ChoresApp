...
public class AddJobsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adding_jobs);
        ...
        adapter = new AddJobsAdapter(this, friendArrayList);
    ...
    private View.OnClickListener onAddingListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final Dialog dialog = new Dialog(AddJobsActivity.this);
                ...
                ArrayAdapter<String> spnAdapter = new ArrayAdapter<String>(AddJobsActivity.this,
