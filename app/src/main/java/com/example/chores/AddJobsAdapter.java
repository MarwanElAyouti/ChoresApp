...
public class AddJobsAdapter extends RecyclerView.Adapter<AddJobsAdapter.ViewHolder> {

    private List<Friend> friends;
    private Activity activity;

    public AddJobsAdapter(Activity activity, List<Friend> friends) {
    ...
    @Override
    public void onBindViewHolder(AddJobsAdapter.ViewHolder viewHolder, int position) {
    ...
    private void setDataToView(TextView name, TextView job, ImageView genderIcon, int position) {
        ...
        if (friends.get(position).isGender()) {
            genderIcon.setImageResource(R.mipmap.ic_launcher_round);
        } else {
            genderIcon.setImageResource(R.mipmap.ic_launcher_round);
        }
    }
